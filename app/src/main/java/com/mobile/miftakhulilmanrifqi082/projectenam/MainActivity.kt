package com.mobile.miftakhulilmanrifqi082.projectenam

import android.content.Intent
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.recyclerview.widget.LinearLayoutManager
import com.mobile.miftakhulilmanrifqi082.projectenam.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPhoneData() : List<PhoneData> {
        ...
        partList.add(PhoneData("Delis Rahmawati", 6282251204791, "Air Upas", "delis.rahmawati46@gmail.com", "Pacar", "WhatsApp,Facebook,Instagram"))
        return partList
    }
